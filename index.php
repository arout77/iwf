...
<body class="min-h-screen flex flex-col items-center py-8 px-4 sm:px-6 text-gray-100 antialiased">
    ...
    <script>
        ...
        const wrestlersData = [
            ...
            {
                name: "Brian Pillman",
                description: "The Loose Cannon. Unpredictable, high-flying, and intense.",
                ...
                moves: {
                    ...
                    highFlying: { name: "Missile Dropkick", damage: { min: 11, max: 17 }, baseHitChance: 0.7, stat: 'aerialAbility' },
                    finisher: { name: "Pillmanizer (Pillman's Neckbreaker)", damage: { min: 25, max: 35 }, baseHitChance: 0.9, stat: 'technicalAbility' }
                }
            },
            {
                name: "Larry Zbyszko",
            ...
            {
                name: "Gunther",
                description: "The Ring General. Dominant, powerful, and technically precise.",
                baseHp: getRandomInt(100, 115),
                strength: getRandomInt(90, 100),
                technicalAbility: getRandomInt(80, 95),
                brawlingAbility: getRandomInt(85, 100),
            ...
            {
                name: "Braun Strowman",
                description: "The Monster Among Men. An unstoppable force of nature.",
                baseHp: getRandomInt(110, 125),
                ...
                moves: {
                    ...
                    highFlying: { name: "Big Boot", damage: { min: 12, max: 18 }, baseHitChance: 0.7, stat: 'strength' },
            ...
            {
                name: "Bron Breakker",
                description: "Steiner bloodline, powerful and athletic.",
                baseHp: getRandomInt(90, 105),
                strength: getRandomInt(85, 100),
                technicalAbility: getRandomInt(70, 85),
                brawlingAbility: getRandomInt(75, 90),
            ...
            {
                name: "Dan Spivey",
                description: "Towering and powerful, a formidable opponent.",
                baseHp: getRandomInt(95, 110),
                strength: getRandomInt(85, 95),
                technicalAbility: getRandomInt(50, 70),
                brawlingAbility: getRandomInt(80, 95),
            ...
            {
                name: "Daniel Bryan",
                description: "The American Dragon. Technical wizard and submission specialist.",
                baseHp: getRandomInt(85, 100),
                strength: getRandomInt(65, 80),
                ...
                moves: {
                    ...
                    highFlying: { name: "Suicide Dive", damage: { min: 10, max: 16 }, baseHitChance: 0.7, stat: 'aerialAbility' },
                    finisher: { name: "Yes Lock (Omoplata Crossface)", damage: { min: 25, max: 35 }, baseHitChance: 0.95, stat: 'technicalAbility' }
                }
            },
            {
                name: "Omos",
